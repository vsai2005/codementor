...
class SAPCurriculumKnowledgeEngine:
    ...
    def get_remediation_capsule(self, concept_slug: str) -> RemediationCapsule | None:
        ...
        concept_aliases = {
            ...
            "org-structure-logistics": "remediation-org-structure",
            "fiori-launchpad-overview": "remediation-fiori-elements",
            "double-entry-accounting": "remediation-acdoca",
            "subledger-vs-gl": "remediation-acdoca",
            "central-business-configuration": "remediation-clean-core",
            "cloud-3-system-landscape": "remediation-clean-core",
            "relational-modeling": "remediation-cds",
            # Phase 5: SAP Fiori & Enterprise UX
            "fiori-design-principles": "remediation-fiori-elements",
            "fiori-app-types": "remediation-fiori-elements",
            "flp-spaces-and-pages": "remediation-fiori-elements",
            "business-catalogs-groups": "remediation-fiori-elements",
            "sapui5-mvc-architecture": "remediation-fiori-elements",
            "ui5-data-binding": "remediation-fiori-elements",
            "odata-protocol-fundamentals": "remediation-fiori-elements",
            "odata-v2-vs-v4": "remediation-fiori-elements",
            "sap-gateway-registration": "remediation-fiori-elements",
            "fiori-elements-paradigm": "remediation-fiori-elements",
            "ui-annotations-framework": "remediation-fiori-elements",
            "ui-lineitem-annotations": "remediation-fiori-elements",
            "ui-selectionfields-annotations": "remediation-fiori-elements",
            "list-report-floorplan": "remediation-fiori-elements",
            "object-page-floorplan": "remediation-fiori-elements",
            "facet-navigation": "remediation-fiori-elements",
            "overview-page-ovp": "remediation-fiori-elements",
            "analytical-cards-ovp": "remediation-fiori-elements",
            "fiori-ux-synthesis": "remediation-fiori-elements",
            # Phase 6: S/4HANA Cloud & Clean Core
            "cloud-governance-models": "remediation-clean-core",
            "activate-quality-gates": "remediation-clean-core",
            "best-practices-scope-items": "remediation-clean-core",
            "cbc-configuration": "remediation-clean-core",
            "scoping-and-fine-tuning": "remediation-clean-core",
            "custom-fields-and-logic": "remediation-clean-core",
            "restricted-abap-cloud": "remediation-abap-cloud",
            "released-apis-c1": "remediation-abap-cloud",
            "btp-extension-architecture": "remediation-clean-core",
            "migration-staging-tables": "remediation-clean-core",
            "cloud-test-automation": "remediation-clean-core",
            "upgrade-regression-testing": "remediation-clean-core",
            "cutover-strategy": "remediation-clean-core",
            "hypercare-operations": "remediation-clean-core",
            "clean-core-roadmap-synthesis": "remediation-clean-core",
            # Phase 7: ABAP Cloud & RAP
            "abap-unit-testing": "remediation-abap-cloud",
            "oop-fundamentals": "remediation-abap-cloud",
            "bdef-and-behavior-implementation": "remediation-rap-behavior",
            "composition-hierarchies": "remediation-rap-behavior",
            "transactional-lifecycle": "remediation-rap-behavior",
            "determination-triggers": "remediation-rap-behavior",
            "failed-reported-structures": "remediation-rap-behavior",
            "entity-manipulation-language-eml": "remediation-rap-behavior",
            "draft-activation-lifecycle": "remediation-rap-behavior",
            "optimistic-locking-etag": "remediation-rap-behavior",
            "rap-full-stack-synthesis": "remediation-rap-behavior",
            # Phase 8: SAP BTP & Enterprise Integration
            "cloud-foundry-vs-kyma": "remediation-cpi-integration",
            "cloud-connector": "remediation-cpi-integration",
            "sync-vs-async-integration": "remediation-cpi-integration",
            "api-oauth2-fundamentals": "remediation-cpi-integration",
            "iflow-design": "remediation-cpi-integration",
            "iflow-groovy-scripting": "remediation-cpi-integration",
            "content-enricher-pattern": "remediation-cpi-integration",
            "event-driven-architecture": "remediation-cpi-integration",
            "s4hana-business-events": "remediation-cpi-integration",
            "enterprise-integration-synthesis": "remediation-cpi-integration",
            # Phase 9: Enterprise Capstone
            "capstone-rap-implementation": "remediation-enterprise-capstone",
            "capstone-fiori-btp-integration": "remediation-enterprise-capstone",
            "capstone-final-defense": "remediation-enterprise-capstone",
        }
